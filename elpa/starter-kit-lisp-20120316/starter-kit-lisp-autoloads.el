...

;;;### (autoloads nil "starter-kit-lisp" "starter-kit-lisp.el" (20378
;;;;;;  3215))
...
(dolist (mode '(scheme emacs-lisp lisp clojure clojurescript)) (when (> (display-color-cells) 8) (font-lock-add-keywords (intern (concat (symbol-name mode) "-mode")) '(("(\\|)" quote esk-paren-face)))) (add-hook (intern (concat (symbol-name mode) "-mode-hook")) 'esk-turn-on-paredit))
...
;;;***

;;;### (autoloads nil nil ("starter-kit-lisp-pkg.el") (20378 3215
;;;;;;  858741))
